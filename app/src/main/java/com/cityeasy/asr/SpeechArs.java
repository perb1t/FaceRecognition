...
public class SpeechArs {
    ...
    public void bindService(Context context) {
        ...
        boolean ret = mAppCtx.bindService(RobotsUtils.createExplicitFromImplicitIntent(context,new Intent(ISpeechAsr.class.getName()) ), mAsrService, Context.BIND_AUTO_CREATE);
