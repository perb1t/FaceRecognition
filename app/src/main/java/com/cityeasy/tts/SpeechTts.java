...
public class SpeechTts {
    ...
    public void bindService(Context context) {
        ...
        boolean ret = mAppCtx.bindService(RobotsUtils.createExplicitFromImplicitIntent(context,new Intent(ISpeechTts.class.getName())), mTTsService, Context.BIND_AUTO_CREATE);
