...
public class ScrollMenuView<T> extends LinearLayout implements
    ...
    private void initialize(Context context) {
        ...
        LayoutParams lpOfPager = new LayoutParams(
        ...
        LayoutParams lpOfCircleLayout = new LayoutParams(
                LayoutParams.WRAP_CONTENT,
                10);
    ...
    class MenuAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                LayoutParams lpOfIcon = new LayoutParams(
                        mIconWidth,
                        mIconWidth);
                ...
                LayoutParams lpOfLable = new LayoutParams(
                        LayoutParams.WRAP_CONTENT,
                        LayoutParams.WRAP_CONTENT);
