...
public class XFaceDetector {
    ...
    public interface FaceDetectCallback {
         ...
         * @param faceNumber
         */
        void detectCallback(int faceNumber, Bitmap face, FaceDetector.Face[] faceSet);
    }
    ...
    private void detect(Bitmap source) {
        ...
        if (mFaceDetectCallback != null)
            mFaceDetectCallback.detectCallback(mReallyDetectFaceNumber, mFaceBitmap,mFaceSet);
    }
