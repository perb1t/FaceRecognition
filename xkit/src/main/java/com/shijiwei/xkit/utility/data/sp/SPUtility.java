...
/**
 * Created by shijiwei on 2017/8/22.
 */
public class SPUtility {
    ...
    public static final String HZ_ROTOT_FACE_CONFIG = "hz_rotot_face_config";
    public static final String PERSON_ID = "person_id";
    public static final String PERSON_HEADER = "person_header";
    public static final String ORG_ID = "org_id";
    public static final String WELCOME_WORD = "welcome_word";


    public SPUtility(Context context, String fileName) {
