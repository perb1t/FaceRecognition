...
//                        drawValue(c, formatter, value, entry, 0, labelPtx, labelPty, dataSet.getValueTextColor(j));
                        //shijiwei update
                        drawValueName(c, data.getXVals().get(j), labelPtx, labelPty, dataSet.getValueTextColor(j));

                        if (j < data.getXValCount()) {
//                            c.drawText(data.getXVals().get(j), labelPtx, labelPty + lineHeight,
//                                    mValuePaint);
                            //shijiwei update
//                            c.drawText(value + "", labelPtx, labelPty + lineHeight,
//                                    mValuePaint);
                        }
...
//                                .getValueTextColor(j));
                        // shijiwei upate
                        drawValueName(c, data.getXVals().get(j), labelPtx, labelPty + lineHeight / 2.f, dataSet
                                .getValueTextColor(j));
                    }
                }
...
//                        drawValue(c, formatter, value, entry, 0, x, y, dataSet.getValueTextColor(j));
                        // shijiwei upate
                        drawValueName(c, data.getXVals().get(j), x, y, dataSet.getValueTextColor(j));

                        if (j < data.getXValCount()) {
//                            c.drawText(data.getXVals().get(j), x, y + lineHeight,
//                                    mValuePaint);
                            //shijiwei update
//                            c.drawText(value + "", x, y + lineHeight,
//                                    mValuePaint);
                        }
...
//                            c.drawText(data.getXVals().get(j), x, y + lineHeight / 2f, mValuePaint);
                            // shijiwei upate
//                            c.drawText(value + "", x, y + lineHeight / 2f, mValuePaint);
                        }
                    } else if (drawYInside) {

//                        drawValue(c, formatter, value, entry, 0, x, y + lineHeight / 2f, dataSet.getValueTextColor(j));
                        // shijiwei update
                        drawValueName(c, data.getXVals().get(j), x, y + lineHeight / 2f, dataSet.getValueTextColor(j));
                    }
                }
